...
assert media("x",4,5.0,"X") == Exception
assert media(3,4,5,"X") == Exception
assert media(3,4,5,"a") == Exception
assert media("A",4,5,"P") == Exception
assert media(3,4,5,6) == Exception
assert media(30,4,5,"A") == Exception
assert media(3,40,5,"A") == Exception
assert media(3,4,50,"A") == Exception
assert media(30,4,5,"P") == Exception
assert media(3,40,5,"P") == Exception
assert media(3,4,50,"P") == Exception
assert media(True,4,4,"A") == Exception
assert media(3,4,5,"A") == 4
assert media(3.5,3.5,5,"A") == 4.0
