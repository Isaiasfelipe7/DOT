...
assert media_final(2.7) == 'D'
assert media_final(4.3) == 'D'
assert media_final(6.2) == 'C'
assert media_final(5.7) == 'C'
assert media_final(6.9) == 'C'
assert media_final(7.0) == 'B'
assert media_final(7.8) == 'B'
assert media_final(8.4) == 'B'
assert media_final(9.1) == 'A'
assert media_final(9.9) == 'A'
assert media_final(9.7) == 'A'
